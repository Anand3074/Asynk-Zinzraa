...
const ProfileNav = ({active,setActive}) => {
  ...
  return (
    <div className=' border-r-[1px] flex items-center justify-center  bg-gray-100 
    rounded-xl mt-3 py-4 xl:px-1' >
       <button value="profile" onClick={(e)=>setActive("profile")} 
        className={active==="profile" ? activeBtn :inActiveBtn} >
            <h4 className='text-white-200 font-[600] lg:text-[1.5rem] text-[0.5rem] 
       ...
       <button value="address" onClick={(e)=>setActive("address")} className={active==="address" ? activeBtn :inActiveBtn} >
            <h4 className='text-white-200 font-[600] lg:text-[1.5rem] text-[0.5rem] flex items-center justify-center' >

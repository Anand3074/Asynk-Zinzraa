...
const BottomFilter = ({ size, setSize, 
 ...
 return (
    ...
    >
      {(isFilterVisible) &&
      (<>
      <div className='fixed top-[0vw] right-[0vw] bg-gray-400 h-full'> 
        ...
        <List className=' w-[8vw] font-bold text-[4vw]'>
            ...
            <div className=' sm:hidden bg-white w-[85vw]  h-[160vw]
...
<div className="fixed h-[12.5vw] bottom-[0vw] sm:hidden w-full bg-white">
      <div className="grid grid-cols-3 h-full p-[2vw] bg-gray-300">
        <button className=" text-center text-[3.75vw] font-semibold 
        font-metro text-gray-800  border-r-[0.2vw] border-r-gray-400">
          Category
        </button>
        <button className=" flex flex-row 
         justify-center items-center gap-[0.5vw] text-[3.75vw] font-semibold 
         font-metro text-center text-gray-800  border-r-[0.2vw] border-r-gray-400">
          <FaSortAmountDown/>Sort
        </button>
        <button onClick={() => toggleFilter()} className=" flex flex-row 
         justify-center items-center gap-[0.5vw] text-[3.75vw] font-semibold 
         font-metro text-center text-gray-800 ">
          <FaFilter/> Filter
        </button>
      </div>
    </div>

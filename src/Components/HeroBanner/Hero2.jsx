...
const Hero2 = () => {
  return (
    <div className='flex relative bg-[#bd9d6ecc] h-[36vw]'>
        <div className='flex flex-col w-[44vw] font-fashion font-light text-[4.3vw]  justify-center text-white'>
            ...
            <div className='z-1 absolute lg:left-[28.5vw] left-[28.5vw] xl:left-[28.5vw]

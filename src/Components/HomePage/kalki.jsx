  ...
  return (
    <div className=' w-full  '>
        <div className='mx-[2.5vw]'>
            ...
            <div className='flex justify-center text-[#875A33] font-lora md:text-[38px] md:mb-[24px] mb-[8px]' >
        ...
        <div className='flex flex-col md:ml-[8vw]'>
            <div className='flex flex-rows gap-[1vw]'>
                <div className='h-[22vw] sm:w-[15vw] sm:h-[16vw] my-[0.3vw] '>
                    <img src={K1} alt='' className=' h-[21vw] rounded-tr-[10vw] sm:rounded-tr-[10vw] 
                    rounded-bl-[10vw] sm:rounded-bl-[10vw]  sm:h-[16vw] h-[90px] sm:w-[15vw]  
                    sm:m-[1vw] m-[1vw]' />
                </div>
                <div className='h-[22vw] sm:w-[15vw] sm:h-[16vw] my-[0.3vw] '>
                    <img src={K2} alt='' className=' h-[21vw] rounded-tl-[10vw] sm:rounded-tl-[10vw] 
            ...
            <div className=' flex flex-rows gap-[1vw]'>
                <div className='h-[22vw] sm:w-[15vw] sm:h-[16vw] my-[0.3vw] '>
                <img src={K3} alt='' className=' h-[21vw] rounded-tl-[10vw] sm:rounded-tl-[10vw] 
                 rounded-br-[10vw] sm:rounded-br-[10vw]  sm:h-[16vw] h-[90px] sm:w-[15vw]  
                 sm:m-[1vw] m-[1vw]' />
                 </div>
                <div className='h-[22vw] sm:w-[15vw] sm:h-[16vw] my-[0.3vw] '>
                <img src={K4} alt='' className=' h-[21vw] rounded-tr-[10vw] sm:rounded-tr-[10vw] 
